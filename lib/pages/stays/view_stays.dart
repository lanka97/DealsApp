...
class ViewStays extends StatefulWidget {
  static const routeName = "view_stays";
  @override
  _ViewStaysState createState() => _ViewStaysState();
}

class _ViewStaysState extends State<ViewStays> with SingleTickerProviderStateMixin{
  HotelDetails _hotel;
